...
/*
todo: 
- list of ints/decimals not converted to numeral
- whitelist/transform elements
*/
/*
...
class ParseFile {
    ...
    * gen(s){
    ...
    parse(t){
        ...
        var i = 0;
        while (contains(t, '{')) {
            console.log('STILL CONTAINS', t.count('{'))
            //console.log("\n\n", t, "\n\n")
            var t = this.gen2(t)
            //i++;
            //if (i == 5) { break;}
    ...
    resolve_placeholder (phkey){
        ...
        console.log('loading placeholder', phkey, Object.keys(this.placeholders).length);
        var nospace = /\s+/g
        if (contains(ph, '=')) {
            // Normal
            //prnumeral('normal', ph)
